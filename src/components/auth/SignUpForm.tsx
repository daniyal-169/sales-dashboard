      ...
      <div className="flex flex-col justify-center flex-1 w-full max-w-md mx-auto">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="flex items-center gap-2 text-sm text-gray-700 dark:text-gray-400">
            ...
            />
            I agree to the{" "}
            <Link to="/terms" className="text-[#01B6D5] hover:text-[#015F6F] dark:text-blue-400">
              Terms & Conditions
            </Link>
          </div>
        ...
        <p className="mt-5 text-sm text-center text-gray-700 dark:text-gray-400">
          ...
          <Link to="/signin" className="text-[#01B6D5] hover:text-[#015F6F] dark:text-blue-400">
            Sign In
          </Link>
        </p>
